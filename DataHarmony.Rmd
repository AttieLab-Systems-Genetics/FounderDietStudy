...
These are data prepared by Mark using an Excel script.
...
## PlaMetAll: Plasma metabolites at 120 minutes
...
harmonize("LivRna", links, LivRnaHarmony, annot,
          condition_name = condition_name, normalize = FALSE)
```
...
```{r}
bind_traits(c("Physio","PlaMet0","PlaMet120","PlaMetAll","LivMet","Lipid","Module","Enrich","PlaEnrich","LivEnrich"))
```
...
```{r}
bind_traits(c("Physio","LivMet","Lipid","LivRna"), traitRoot = "liver")
```
