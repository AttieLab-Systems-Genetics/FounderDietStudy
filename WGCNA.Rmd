...
```{r}
datasets <- c("Physio","LivMet","PlaMetAll","Lipid","LivRna","LivMet","PlaEnrich")
pvalmax <- 0.05
```
...
```{r}
LivMetEigen <- 
  foundr::eigen_contrast(traitModule$LivMet, traitContrast$LivMet)
```
